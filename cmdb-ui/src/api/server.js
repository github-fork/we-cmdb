...
export const getPermissionsByRole = roleId => req.get(`/admin/roles/${roleId}/permissions`)
...
export const addUsersToRole = (users, roleId) => req.post(`/admin/roles/${roleId}/users`, users)
export const romoveUsersFromRole = (users, roleId) => req.delete(`/admin/roles/${roleId}/users`, { data: users })
export const addMenusToRole = (menuCodes, roleId) => req.post(`/admin/roles/${roleId}/menu-permissions`, menuCodes)
export const removeMenusFromRole = (menuCodes, roleId) =>
  req.delete(`/admin/roles/${roleId}/menu-permissions`, {
    data: menuCodes
  })
export const addDataPermissionAction = (roleId, ciTypeId, actionCode) => req.post(`/admin/roles/${roleId}/citypes/${ciTypeId}/actions/${actionCode}`)
export const removeDataPermissionAction = (roleId, ciTypeId, actionCode) => req.delete(`/admin/roles/${roleId}/citypes/${ciTypeId}/actions/${actionCode}`)
export const getRoleCiTypeCtrlAttributesByRoleCiTypeId = roleCitypeId => req.get(`/admin/role-citypes/${roleCitypeId}/ctrl-attributes`)
export const createRoleCiTypeCtrlAttributes = (roleCitypeId, data) => req.post(`/admin/role-citypes/${roleCitypeId}/ctrl-attributes/create`, data)
export const updateRoleCiTypeCtrlAttributes = (roleCitypeId, data) => req.post(`/admin/role-citypes/${roleCitypeId}/ctrl-attributes/update`, data)
export const deleteRoleCiTypeCtrlAttributes = (roleCitypeId, data) => req.post(`/admin/role-citypes/${roleCitypeId}/ctrl-attributes/delete`, data)
...
// enum
export const getEnumCodesByCategoryId = (catTypeId, catId) => req.get(`/enum/category-types/${catTypeId}/categories/${catId}/codes`)
...
export const swapLayerPosition = (layerId, targetLayerId) => req.post(`/ci-type-layers/${layerId}/swap-position?target-layer-id=${targetLayerId}`)
...
export const getEnumByCIType = id => req.get(`/enum/category-types/categories/query-by-multiple-types?ci-type-id=${id}&types=common-private`)
...
export const getPlanningDesignsCiData = data => req.post(`/planning-designs/ci-data?code-id=${data.id}&idcs-guid=${data.idcGuid}`, data.queryObject)
export const getResourcePlanningCiData = data => req.post(`/resource-planning/ci-data?code-id=${data.id}&idcs-guid=${data.idcGuid}`, data.queryObject)
export const getAllZoneLinkGroupByIdc = () => req.get(`/all-zone-link`)
export const getSystemDesigns = () => {
  return req.get(`/system-designs`)
}
export const getAllDesignTreeFromSystemDesign = id => req.get(`/trees/all-design-trees/from-system-design?system-design-guid=${id}`)
export const saveAllDesignTreeFromSystemDesign = id => req.post(`/trees/all-design-trees/from-system-design/save?system-design-guid=${id}`)
export const getArchitectureDesignTabs = () => req.get('/architecture-designs/tabs')
export const getArchitectureCiDatas = (tabId, sysId, payload) => req.post(`/architecture-designs/tabs/ci-data?code-id=${tabId}&system-design-guid=${sysId}`, payload)
...
export const getDeployCiData = (data, payload) => req.post(`/deploy-designs/tabs/ci-data?code-id=${data.codeId}&env-code=${data.envCode}&system-design-guid=${data.systemDesignGuid}`, payload)
...
export const getAllDeployTreesFromDesignCi = (id, env) => {
  return req.get(`/trees/all-deploy-trees/from-subsys?env-code=${env}&system-design-guid=${id}`)
}
export const startProcessInstancesWithCiDataInbatch = data => {
  return req.post(`/process/inbatch/instances`, data)
}
export const getApplicationDeploymentDesignDataTree = (guid, codeId) => req.get(`/data-tree/application-deployment-design?env-code=${codeId}&system-design-guid=${guid}`)
export const queryEnumCategories = data => req.post(`/enum/categories/query`, data)
export const queryEnumCodes = (catTypeId, catId, data) => req.post(`/enum/category-types/${catTypeId}/categories/${catId}/codes/query`, data)
