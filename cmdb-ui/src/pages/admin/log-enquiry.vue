<template>
  <WeCMDBTable :tableData="tableData" :tableColumns="columns" :tableOuterActions="outerActions" :tableInnerActions="null" :showCheckbox="false" :pagination="pageInfo" @sortHandler="sortHandler" @pageChange="pageChange" @pageSizeChange="pageSizeChange" @handleSubmit="handleSubmit" ref="table"></WeCMDBTable>
</template>
