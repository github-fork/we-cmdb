<template>
  <div>
    ...
    <Row v-if="!!selectedQueryName" style="margin-top: 20px;">
      <WeCMDBTable :tableData="tableData" :tableOuterActions="outerActions" :tableInnerActions="innerActions" :tableColumns="tableColumns" :pagination="pagination" :showCheckbox="false" :isColumnsFilterOn="false" @actionFun="actionFun" @pageChange="pageChange" @pageSizeChange="pageSizeChange" @sortHandler="sortHandler" @handleSubmit="handleSubmit" tableHeight="650" ref="table"></WeCMDBTable>
