<template>
  <Row>
    <Col span="19">
      <WeCMDBAttrInput v-if="mappingType === 'CMDB_CI_TYPE'" :allCiTypes="allCiTypes" :cmdbColumnSource="paramData.cmdbColumnSource" :rootCiType="rootCiType" v-model="cmdbAttr" :ciTypesObj="ciTypesObj" :ciTypeAttributeObj="ciTypeAttributeObj" @change="cmdbAttrChangeHandler" />
      <Select v-if="mappingType === 'CMDB_ENUM_CODE'" @on-change="cmdbEnumCodeChangeHandler" v-model="cmdbEnumCode" filterable>
