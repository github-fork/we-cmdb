...
export default {
  ...
  methods: {
    ...
    renderTos () {
      ...
      return <Tree data={data} show-checkbox={true} on-on-check-change={(all, current) => this.handleReferToChange(all, current)} />
    },
    renderBys () {
      ...
      return <Tree data={data} show-checkbox={true} on-on-check-change={(all, current) => this.handleReferByChange(all, current)} />
    },
    renderAttrs () {
      ...
      return <Tree data={data} show-checkbox={true} on-on-check-change={(all, current) => this.handleCiTypeAttrChange(all, current)} />
    },
